...
const DEFAULT_COLORS = ["#2f7dff", "#46d8ff", "#8f7dff", "#02050a"];
...
const Velaris = ({
  ...
  useEffect(() => {
    ...
    const palette = [...colors.slice(0, 4), ...DEFAULT_COLORS].slice(0, 4);
    ...
    const render = (time: number) => {
      ...
      gl.uniform1f(locations.time, reduceMotion ? 0 : time * 0.001 * speed);
